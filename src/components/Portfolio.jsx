            ...
            { portfolio.map(({id, src}) => (
                    <div key={id}className='shadow-md shadow-gray-600 rounded-lg'>
                        ...
                        <div className='flex items-center justify-center'>
                            <button className='w-1/2 px-6 m-4 duration-200 hover:scale-110 font-thin'>Demo</button>
                            <button className='w-1/2 px-6 m-4 duration-200 hover:scale-110 font-thin'>Code</button>
                        </div>
                    </div>
                ))
            }
